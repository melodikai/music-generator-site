...
export const PROMPT_IDEAS = [
  ...
  'Драйвовый рок с электрогитарами для автопутешествия',
  'Спокойный джаз для вечера в кафе, саксофон',
  'Лёгкое регги для летнего пляжного ролика',
  'Кинематографичный подъём со струнными для финала',
  'Тяжёлый метал с мощными барабанами',
];
