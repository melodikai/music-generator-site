      ...
      >
        ...
        <button
          ...
          onClick={(e) => {
            ...
            setPosition(Math.round(((e.clientX - rect.left) / rect.width) * total));
          }}
        ...
        <span className="ml-auto flex-none text-[0.82em] tabular-nums text-card-muted sm:ml-0">
          {fromSeconds(position)} / {track.duration}
        </span>
        ...
        <div className="flex flex-none items-center gap-1">
          ...
          <button
            ...
            className="hidden h-8 w-8 place-items-center rounded-full text-card-muted transition-colors hover:bg-black/5 hover:text-card-foreground sm:grid"
          >
